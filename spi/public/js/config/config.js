...
+'         ?wi event:definedByWorkflow ?w.\n'
+'         ?a workflow:partOfWorkflow ?w.\n'
+'         ?a workflow:performedByApplication ?app.\n'
+'       }\n'
+'     }\n'
+'   }\n'
+'   GROUP By ?s ?sName\n'
...
var config_queries_participantStatistics=
...
config_queries_statistics_quality =
 'SELECT ?s ?sName ?w ?wName ?numberOpened ?numberCompleted\n'
+'WHERE{\n'
+'  {\n'
+'    SELECT ?s ?sName ?w ?wName (COUNT(?event) as ?numberOpened)\n'
+'    WHERE \n'
+'    { \n'
+'      ?event event:originatedFromWorkflowInstance ?wi; a event:OpenEvent.\n'
+'      ?wi event:definedByWorkflow ?w.\n'
+'      ?w workflow:hasWorkflowName ?wName.\n'
+'      ?wi event:generatedBySystem ?s.\n'
+'      ?s system:hasSystemName ?sName.\n'
...
+'  .\n'
+'  {\n'
+'    SELECT ?s ?sName ?w ?wName (COUNT(?event) as ?numberCompleted)\n'
+'    WHERE \n'
+'    { \n'
+'      ?event event:originatedFromWorkflowInstance ?wi; a event:CompletedEvent.\n'
+'      ?wi event:definedByWorkflow ?w.\n'
+'      ?w workflow:hasWorkflowName ?wName.\n'
+'      ?wi event:generatedBySystem ?s.\n'
+'      ?s system:hasSystemName ?sName.\n'
