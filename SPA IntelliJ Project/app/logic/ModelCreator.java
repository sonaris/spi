...
public class ModelCreator {
    ...
    public void createTransition(String id, String aIdSource, String aIdTarget, String condition) {
        if (transitions.get(id) == null) {
            ...
            this.activityDefinitions.get(aIdTarget).addProperty(ontModel.getOntProperty(Settings.workflowOntologyNameSpace + "#precededByActivity"), this.activityDefinitions.get(aIdSource));
    ...
    public void connectActivityDefinitionToPerformer(String aId, String pId, String apId) {
        if (pId != null) activityDefinitions.get(aId).addProperty(ontModel.getOntProperty(Settings.workflowOntologyNameSpace + "#hasParticipantPerformer"), participants.get(pId));
        if (apId != null) activityDefinitions.get(aId).addProperty(ontModel.getOntProperty(Settings.workflowOntologyNameSpace + "#hasApplicationPerformer"), applications.get(apId));
    }
